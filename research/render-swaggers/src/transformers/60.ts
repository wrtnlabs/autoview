...
namespace Schema {
    ...
    */
    export type IPageIShoppingCouponTicket = {
        ...
        */
        data: Schema.IShoppingCouponTicket[];
    };
...
type IAutoViewTransformerInputType = Schema.IPageIShoppingCouponTicket;
...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  const items: IAutoView.IAutoViewDataListItemProps[] = input.data.map((ticket) => {
    ...
    const couponName = ticket.coupon?.name ?? ticket.coupon?.id ?? "Unknown Coupon";
