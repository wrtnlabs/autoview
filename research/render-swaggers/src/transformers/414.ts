...
type IAutoViewTransformerInputType = Schema.IApiOrgsActionsSecretsRepositories.GetResponse;
...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  const listItems: IAutoView.IAutoViewListItemProps[] = input.repositories.map(repo => {
    ...
    const statsChips: IAutoView.IAutoViewChipProps[] = [
      ...
      {
        type: "Chip",
        label: String(repo.forks_count ?? 0),
        startElement: {
          type: "Icon",
          id: "code-branch",
          color: "cyan",
      ...
      {
        type: "Chip",
        label: String(repo.open_issues_count ?? 0),
        startElement: {
          type: "Icon",
