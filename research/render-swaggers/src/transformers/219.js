...
function visualizeData(input) {
    ...
    const keywordChips = (_b = (_a = webhook.keywords) === null || _a === void 0 ? void 0 : _a.map((kw) => ({
        type: "Chip",
        label: kw,
        size: "small",
        variant: "outlined",
    ...
    const listItems = [
        {
            ...
            value: [{ type: "Text", content: (_c = webhook.id) !== null && _c !== void 0 ? _c : "N/A", variant: "body1" }],
        },
        {
            type: "DataListItem",
            label: [{ type: "Text", content: "Channel ID", variant: "subtitle2" }],
            value: [
                { type: "Text", content: (_d = webhook.channelId) !== null && _d !== void 0 ? _d : "N/A", variant: "body1" },
            ],
        },
        {
            type: "DataListItem",
