...
namespace Schema {
    ...
    */
    export type IPageIShoppingCartCommodity = {
        ...
        */
        data: Schema.IShoppingCartCommodity[];
    };
...
type IAutoViewTransformerInputType = Schema.IPageIShoppingCartCommodity;
...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
    ...
    const listItems: IAutoView.IAutoViewDataListItemProps[] = input.data.map(item => {
