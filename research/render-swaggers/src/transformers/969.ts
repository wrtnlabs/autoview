...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
    ...
    const listItems: IAutoView.IAutoViewListItemProps[] = input.map((pkg) => {
        ...
        const startElement: IAutoView.IAutoViewAvatarProps | IAutoView.IAutoViewIconProps = pkg.owner && pkg.owner.avatar_url
            ? {
                  type: "Avatar",
        ...
        const versionBadge: IAutoView.IAutoViewBadgeProps = {
            type: "Badge",
        ...
        return {
            type: "ListItem",
            title: pkg.name,
            description: `Updated: ${updatedDate}`,
            startElement,
            // Show both the type chip and version badge on the right side
            endElement: [typeChip, versionBadge],
            // If the package has a homepage or HTML URL, link the item
            ...(pkg.html_url ? { href: pkg.html_url } : {}),
        };
    });
