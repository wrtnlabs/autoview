...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  function describeEvent(e: Schema.event): string {
  ...
  const items: IAutoView.IAutoViewDataListItemProps[] = input.map((e) => {
    ...
    const timestamp: IAutoView.IAutoViewTextProps = {
      type: "Text",
      variant: "caption",
      color: "secondary",
    ...
    const md: IAutoView.IAutoViewMarkdownProps = {
      type: "Markdown",
