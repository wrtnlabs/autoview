...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  function makeText(content: string, variant: IAutoView.IAutoViewTextProps["variant"] = "body2") : IAutoView.IAutoViewTextProps {
    return {
      type: "Text",
      content,
      variant,
  ...
  const chipGroup: IAutoView.IAutoViewChipGroupProps = {
    ...
    childrenProps: [
      ...
      {
        type: "Chip",
        label: input.machine?.display_name ?? "Unknown machine",
        variant: "outlined",
        size: "small",
      },
    ],
