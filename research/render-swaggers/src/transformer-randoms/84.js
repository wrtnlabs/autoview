...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f, _g; return ({
        ...
        ticket: _ro2(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        coupon: _ro5(_recursive, _recursive ? 1 + _depth : _depth),
        created_at: ((_b = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _b !== void 0 ? _b : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        ...
        inventory: _ro6(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        restriction: _ro7(_recursive, _recursive ? 1 + _depth : _depth),
