...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f; return ({
        ...
        output: _ro1(_recursive, _recursive ? 1 + _depth : _depth),
    ...
    }); }; const _ro3 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f, _g, _h; return ({
        id: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.integer) !== null && _a !== void 0 ? _a : __typia_transform__randomInteger._randomInteger)({
            type: "integer"
        }),
        ...
        permissions: _ro4(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        head: _ro6(_recursive, _recursive ? 1 + _depth : _depth),
        base: _ro8(_recursive, _recursive ? 1 + _depth : _depth)
        ...
        repo: _ro7(_recursive, _recursive ? 1 + _depth : _depth)
        ...
        repo: _ro9(_recursive, _recursive ? 1 + _depth : _depth)
    ...
    }); }; const _ro10 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f, _g, _h, _j; return ({
