...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => ({
        ...
        name: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.pattern) !== null && _a !== void 0 ? _a : __typia_transform__randomPattern._randomPattern)(new RegExp("[\\p{L}\\p{N}-_()]+")),
