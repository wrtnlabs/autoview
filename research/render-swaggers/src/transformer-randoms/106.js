...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f; return ({
    ...
    }); }; const _ro4 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f; return ({
        ...
        price: _ro6(_recursive, _recursive ? 1 + _depth : _depth),
        inventory: _ro7(_recursive, _recursive ? 1 + _depth : _depth),
