...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => ({
        total_count: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        roles: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        base_role: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
            () => "read",
            () => "write",
        ...
        permissions: ((_c = _generator === null || _generator === void 0 ? void 0 : _generator.array) !== null && _c !== void 0 ? _c : __typia_transform__randomArray._randomArray)({
            type: "array",
