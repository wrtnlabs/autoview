...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a, _b; return ({
        ...
        controller_repo: _ro1(_recursive, _recursive ? 1 + _depth : _depth),
        actor: _ro2(_recursive, _recursive ? 1 + _depth : _depth),
        query_language: __typia_transform__randomPick._randomPick([
            () => "python",
            () => "rust",
            () => "swift",
            () => "java",
        ...
        query_pack_url: ((_b = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _b !== void 0 ? _b : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        ...
        actions_workflow_run_id: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        failure_reason: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => "no_repos_queried",
            () => "actions_workflow_run_failed",
            () => "internal_error"
        ])(),
        scanned_repositories: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        skipped_repositories: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        analysis_status: __typia_transform__randomPick._randomPick([
            () => "failed",
            () => "canceled",
            () => "in_progress",
            () => "pending",
        ...
        result_count: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.integer) !== null && _a !== void 0 ? _a : __typia_transform__randomInteger._randomInteger)({
                type: "integer"
            }); }
        ])(),
        artifact_size_in_bytes: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.integer) !== null && _a !== void 0 ? _a : __typia_transform__randomInteger._randomInteger)({
                type: "integer"
            }); }
        ])(),
        failure_message: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
                type: "string"
            }); }
        ...
        full_name: ((_c = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _c !== void 0 ? _c : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        "private": ((_d = _generator === null || _generator === void 0 ? void 0 : _generator.boolean) !== null && _d !== void 0 ? _d : __typia_transform__randomBoolean._randomBoolean)({
            type: "boolean"
        }),
        stargazers_count: ((_e = _generator === null || _generator === void 0 ? void 0 : _generator.integer) !== null && _e !== void 0 ? _e : __typia_transform__randomInteger._randomInteger)({
            type: "integer"
        }),
        updated_at: __typia_transform__randomPick._randomPick([
            () => null,
        ...
        access_mismatch_repos: _ro6(_recursive, _recursive ? 1 + _depth : _depth),
        not_found_repos: _ro7(_recursive, _recursive ? 1 + _depth : _depth),
        no_codeql_db_repos: _ro6(_recursive, _recursive ? 1 + _depth : _depth),
        over_limit_repos: _ro6(_recursive, _recursive ? 1 + _depth : _depth)
    }); const _ro6 = (_recursive = false, _depth = 0) => { var _a, _b; return ({
        repository_count: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.integer) !== null && _a !== void 0 ? _a : __typia_transform__randomInteger._randomInteger)({
            type: "integer"
        }),
        repositories: ((_b = _generator === null || _generator === void 0 ? void 0 : _generator.array) !== null && _b !== void 0 ? _b : __typia_transform__randomArray._randomArray)({
            type: "array",
        ...
        repository_full_names: ((_b = _generator === null || _generator === void 0 ? void 0 : _generator.array) !== null && _b !== void 0 ? _b : __typia_transform__randomArray._randomArray)({
            type: "array",
