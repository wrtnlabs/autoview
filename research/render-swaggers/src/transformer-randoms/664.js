...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => ({
        preferences: _ro1(_recursive, _recursive ? 1 + _depth : _depth),
        repository: _ro3(_recursive, _recursive ? 1 + _depth : _depth)
    }); const _ro1 = (_recursive = false, _depth = 0) => ({
        auto_trigger_checks: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        app_id: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.integer) !== null && _a !== void 0 ? _a : __typia_transform__randomInteger._randomInteger)({
            type: "integer"
        }),
        setting: ((_b = _generator === null || _generator === void 0 ? void 0 : _generator.boolean) !== null && _b !== void 0 ? _b : __typia_transform__randomBoolean._randomBoolean)({
            type: "boolean"
        })
