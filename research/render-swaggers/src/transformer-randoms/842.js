...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f; return ({
        ...
        state: ((_d = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _d !== void 0 ? _d : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        ...
        pull_request_url: ((_f = _generator === null || _generator === void 0 ? void 0 : _generator.uri) !== null && _f !== void 0 ? _f : __typia_transform__randomFormatUri._randomFormatUri)(),
        _links: _ro2(_recursive, _recursive ? 1 + _depth : _depth),
        submitted_at: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        pull_request: _ro4(_recursive, _recursive ? 1 + _depth : _depth)
