...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a; return ({
        ...
        value_type: __typia_transform__randomPick._randomPick([
            () => "string",
            () => "single_select",
            () => "multi_select",
            () => "true_false"
        ...
        default_value: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
                type: "string"
        ...
        allowed_values: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.array) !== null && _a !== void 0 ? _a : __typia_transform__randomArray._randomArray)({
                type: "array",
        ...
        values_editable_by: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
            () => "org_actors",
            () => "org_and_repo_actors"
