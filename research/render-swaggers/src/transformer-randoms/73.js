...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e; return ({
        ...
        sale: _ro1(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        price: _ro14(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        section: _ro2(_recursive, _recursive ? 1 + _depth : _depth),
        seller: _ro3(_recursive, _recursive ? 1 + _depth : _depth),
        id: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        ...
        content: _ro9(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        type: "seller",
        member: _ro4(_recursive, _recursive ? 1 + _depth : _depth),
        customer: _ro6(_recursive, _recursive ? 1 + _depth : _depth),
        citizen: _ro8(_recursive, _recursive ? 1 + _depth : _depth),
        id: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
            type: "string"
        }),
    ...
    }); }; const _ro12 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e; return ({
        ...
        inventory: _ro15(_recursive, _recursive ? 1 + _depth : _depth),
