...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => ({
        ...
        userId: ((_b = _generator === null || _generator === void 0 ? void 0 : _generator.integer) !== null && _b !== void 0 ? _b : __typia_transform__randomInteger._randomInteger)({
            type: "integer"
        }),
        resourceName: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
                type: "string"
            }); }
        ])(),
        resourceId: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        redirectLink: __typia_transform__randomPick._randomPick([
            () => undefined,
