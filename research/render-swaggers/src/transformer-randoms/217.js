...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => ({
        ...
        watchUserChats: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        watchGroups: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.boolean) !== null && _a !== void 0 ? _a : __typia_transform__randomBoolean._randomBoolean)({
                type: "boolean"
            }); }
        ])(),
        apiVersion: ((_c = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _c !== void 0 ? _c : __typia_transform__randomString._randomString)({
            type: "string"
        }),
