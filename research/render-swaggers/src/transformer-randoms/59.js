...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a, _b; return ({
        ...
        coupon: _ro3(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        inventory: _ro4(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        restriction: _ro5(_recursive, _recursive ? 1 + _depth : _depth),
