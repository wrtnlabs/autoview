...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e; return ({
        ...
        dependency: _ro1(_recursive, _recursive ? 1 + _depth : _depth),
        security_advisory: _ro3(_recursive, _recursive ? 1 + _depth : _depth),
        security_vulnerability: _ro4(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        updated_at: ((_e = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _e !== void 0 ? _e : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        ...
        auto_dismissed_at: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.datetime) !== null && _a !== void 0 ? _a : __typia_transform__randomFormatDatetime._randomFormatDatetime)(); }
        ])(),
        repository: _ro15(_recursive, _recursive ? 1 + _depth : _depth)
    }); }; const _ro1 = (_recursive = false, _depth = 0) => ({
        "package": __typia_transform__randomPick._randomPick([
            () => undefined,
            () => _ro2(_recursive, _recursive ? 1 + _depth : _depth)
        ])(),
        manifest_path: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
                type: "string"
            }); }
        ...
        relationship: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
            () => "unknown",
            () => "direct",
        ...
        ecosystem: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
            type: "string"
        }),
    ...
    }); }; const _ro3 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f, _g, _h, _j; return ({
        ...
        summary: ((_b = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _b !== void 0 ? _b : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        description: ((_c = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _c !== void 0 ? _c : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        vulnerabilities: ((_d = _generator === null || _generator === void 0 ? void 0 : _generator.array) !== null && _d !== void 0 ? _d : __typia_transform__randomArray._randomArray)({
            type: "array",
        ...
        cvss: _ro6(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        cwes: ((_e = _generator === null || _generator === void 0 ? void 0 : _generator.array) !== null && _e !== void 0 ? _e : __typia_transform__randomArray._randomArray)({
            type: "array",
            element: () => _ro11(_recursive, _recursive ? 1 + _depth : _depth)
        }),
        identifiers: ((_f = _generator === null || _generator === void 0 ? void 0 : _generator.array) !== null && _f !== void 0 ? _f : __typia_transform__randomArray._randomArray)({
            type: "array",
            element: () => _ro12(_recursive, _recursive ? 1 + _depth : _depth)
        }),
        references: ((_g = _generator === null || _generator === void 0 ? void 0 : _generator.array) !== null && _g !== void 0 ? _g : __typia_transform__randomArray._randomArray)({
            type: "array",
            element: () => _ro13(_recursive, _recursive ? 1 + _depth : _depth)
        }),
        published_at: ((_h = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _h !== void 0 ? _h : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        updated_at: ((_j = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _j !== void 0 ? _j : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        ...
        "package": _ro2(_recursive, _recursive ? 1 + _depth : _depth),
        severity: __typia_transform__randomPick._randomPick([
            () => "medium",
            () => "low",
            () => "high",
        ...
        vulnerable_version_range: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
            type: "string"
        }),
        first_patched_version: __typia_transform__randomPick._randomPick([
            () => null,
            () => _ro5(_recursive, _recursive ? 1 + _depth : _depth)
        ])()
    }); }; const _ro5 = (_recursive = false, _depth = 0) => { var _a; return ({
        identifier: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
            type: "string"
        })
    }); }; const _ro6 = (_recursive = false, _depth = 0) => { var _a; return ({
        score: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.number) !== null && _a !== void 0 ? _a : __typia_transform__randomNumber._randomNumber)({
            type: "number"
        }),
    ...
    }); }; const _ro13 = (_recursive = false, _depth = 0) => { var _a; return ({
        url: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
            type: "string"
        })
    }); }; const _ro14 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s; return ({
    ...
    }); }; const _ro15 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19; return ({
        ...
        owner: _ro16(_recursive, _recursive ? 1 + _depth : _depth),
