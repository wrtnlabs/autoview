...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s; return ({
        assignment: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => "direct",
            () => "indirect",
            () => "mixed"
        ])(),
        inherited_from: __typia_transform__randomPick._randomPick([
            () => undefined,
