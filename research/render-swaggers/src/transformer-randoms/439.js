...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => ({
        total_seats: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        assignee: _ro2(_recursive, _recursive ? 1 + _depth : _depth),
        organization: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
            () => _ro3(_recursive, _recursive ? 1 + _depth : _depth)
        ])(),
        assigning_team: __typia_transform__randomPick._randomPick([
            () => "any type used...",
            () => undefined
        ])(),
        pending_cancellation_date: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
        ...
        last_activity_at: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
        ...
        last_activity_editor: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => null,
        ...
        created_at: ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
            type: "string"
        }),
