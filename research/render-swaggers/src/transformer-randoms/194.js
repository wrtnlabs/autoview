...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => ({
        oneTimeMsgs: __typia_transform__randomPick._randomPick([
            () => undefined,
        ...
        operator: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => _ro4(true, _recursive ? 1 + _depth : _depth)
        ])(),
    ...
    }); const _ro4 = (_recursive = false, _depth = 0) => ({}); const _ro5 = (_recursive = false, _depth = 0) => ({}); const _ro6 = (_recursive = true, _depth = 0) => ({
        oneTimeMsg: _ro7(true, _recursive ? 1 + _depth : _depth)
    }); const _ro7 = (_recursive = true, _depth = 0) => { var _a, _b; return ({
        id: __typia_transform__randomPick._randomPick([
            () => undefined,
            () => { var _a; return ((_a = _generator === null || _generator === void 0 ? void 0 : _generator.string) !== null && _a !== void 0 ? _a : __typia_transform__randomString._randomString)({
                type: "string"
