...
export function random() {
    return (() => { const _ro0 = (_recursive = false, _depth = 0) => { var _a; return ({
        ...
        section: _ro3(_recursive, _recursive ? 1 + _depth : _depth),
        seller: _ro4(_recursive, _recursive ? 1 + _depth : _depth),
        price_range: _ro8(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        content: _ro10(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        type: "seller",
        member: _ro5(_recursive, _recursive ? 1 + _depth : _depth),
        ...
        lowest: _ro9(_recursive, _recursive ? 1 + _depth : _depth),
        highest: _ro9(_recursive, _recursive ? 1 + _depth : _depth)
