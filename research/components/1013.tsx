          ...
          >
            <div className="flex items-center p-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center text-sm text-gray-500 mt-1 overflow-hidden">
            ...
            <div className="px-4 pb-4 pt-2 flex flex-wrap items-center text-gray-500 text-xs border-t">
              ...
              <div className="flex items-center mr-4">
                <LucideReact.Eye size={14} className="mr-1 flex-shrink-0" />
                <span>{watchers}</span>
              </div>
              {repo.language && (
                <div className="flex items-center mr-4">
