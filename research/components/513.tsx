...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  return (
    <div className="space-y-4">
      {value.map((rs) => (
        <div key={rs.id} className="p-4 bg-white rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              {rs.target === 'branch' && <LucideReact.GitBranch className="text-gray-500" size={20} />}
              {rs.target === 'tag' && <LucideReact.Tag className="text-gray-500" size={20} />}
              {rs.target === 'push' && <LucideReact.UploadCloud className="text-gray-500" size={20} />}
              {rs.target === 'repository' && <LucideReact.Database className="text-gray-500" size={20} />}
          ...
          <div className="mt-3 grid grid-cols-2 gap-4 text-sm text-gray-600">
            {rs.source && (
              <div className="flex items-center">
                ...
                <span className="capitalize">{rs.source}</span>
              </div>
            )}
            <div className="flex items-center">
              <LucideReact.Users className="mr-1" size={16} />
              <span>{rs.bypass_actors?.length ?? 0} bypass</span>
            </div>
            <div className="flex items-center">
              <LucideReact.ListChecks className="mr-1" size={16} />
              <span>{rs.rules?.length ?? 0} rules</span>
            </div>
            <div className="flex items-center">
            ...
            <div className="flex items-center col-span-2">
              <LucideReact.RefreshCw className="mr-1" size={16} />
