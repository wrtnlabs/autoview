...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const issuedDate = new Date(value.created_at).toLocaleString();
  const expireDate = value.expired_at
  ...
  const criteriaList =
    coupon.criterias.map((c) => `${c.type} (${c.direction})`).join(", ") ||
    "None";
    ...
    <div className="p-4 bg-white rounded-lg shadow-md max-w-md mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center text-gray-700">
            <LucideReact.Clock className="mr-2 text-gray-500" size={16} />
            <span className="text-sm">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center text-gray-700">
            ...
            <span className="text-sm">
              <strong>Discount:</strong> {discountInfo}
            </span>
          </div>
          <div className="flex items-center text-gray-700">
            {restriction.access === "public" ? (
              ...
              <LucideReact.Lock className="mr-2 text-gray-500" size={16} />
            )}
            <span className="text-sm">
              <strong>Access:</strong> {restriction.access}
            </span>
          </div>
          <div className="flex items-center text-gray-700">
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex items-center text-gray-700">
          <LucideReact.Box className="mr-2 text-gray-500" size={16} />
          <span className="text-sm">
            <strong>Inventory:</strong> {inventoryTotal} total / {inventoryPer}{" "}
            per person
          </span>
        </div>
        <div className="flex items-center text-gray-700">
          ...
          />
          <span className="text-sm">
            <strong>Criteria:</strong> {criteriaList}
          </span>
        </div>
      </div>
      {/* Customer Info */}
