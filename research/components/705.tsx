  ...
  if (prs.length === 0) {
    return (
      <div className="flex flex-col items-center py-8 text-gray-500">
        ...
        <span className="mt-4">No pull requests available</span>
      </div>
    );
  }
        ...
        return (
          ...
          >
            ...
            <div className="flex justify-between items-start">
              <h3 className="text-lg font-semibold text-gray-800 flex-1 truncate">
                #{pr.number} – {pr.title}
              </h3>
              <span
                className={`ml-4 px-2 py-1 text-xs font-medium rounded ${stateClasses}`}
              >
                {stateLabel}
              </span>
            </div>
            ...
            {/* Metadata Row */}
            <div className="mt-3 flex flex-col sm:flex-row sm:items-center sm:space-x-4 text-sm text-gray-500">
              {/* Author */}
