...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  // If no packages, show an empty state
  ...
  // Compose the list of package cards
  return (
    <ul className="space-y-4">
      {value.map((pkg) => {
        ...
        return (
          <li key={pkg.id} className="p-4 bg-white rounded-lg shadow-sm">
            <div className="flex items-start justify-between">
              {/* Title and badges */}
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  <LucideReact.Package className="text-indigo-500" size={20} />
                ...
                <div className="mt-2 flex flex-wrap items-center gap-x-4 text-sm text-gray-600">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 capitalize">{pkg.package_type}</span>
                  </div>
                  {/* Version count */}
                  <div className="flex items-center">
              ...
              {/* Owner avatar */}
              {pkg.owner && pkg.owner.avatar_url && (
                <img
                  src={pkg.owner.avatar_url}
                  alt={pkg.owner.login}
                  className="w-10 h-10 rounded-full object-cover ml-4 flex-shrink-0"
            ...
            {/* Metadata */}
            <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-y-2 text-sm text-gray-500">
              <div className="flex items-center">
