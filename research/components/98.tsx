...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  // Determine writer display name based on writer type
  ...
  // Select the latest snapshot and compute edit count
      ...
      <div className="flex items-center mb-3">
        ...
        {editCount > 0 && (
          <span className="flex items-center text-gray-500 text-sm ml-4">
            ...
            {editCount > 1 ? `${editCount} edits` : '1 edit'}
          </span>
        )}
      </div>
      <div className="text-gray-700 text-sm whitespace-pre-wrap break-words line-clamp-6">
        {latestSnapshot ? (
