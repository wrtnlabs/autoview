          ...
          <img
            ...
            onError={(e) => {
              ...
              e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(
                evt.actor.display_login || evt.actor.login,
          ...
          <div className="ml-4 flex-1">
            <div className="flex flex-wrap items-center gap-1 text-sm text-gray-600">
              ...
              <LucideReact.Activity
                ...
                aria-label="Event"
              />
              <span className="capitalize">{humanizeType(evt.type)}</span>
              <span>on</span>
              <LucideReact.Link
                size={16}
                className="text-gray-500"
            ...
            {evt.payload.issue && (
              <div className="mt-1 text-sm text-gray-700 flex items-center gap-1">
                ...
                />
                <a
                  href={evt.payload.issue.html_url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:underline truncate"
                >
                  #{evt.payload.issue.number} {evt.payload.issue.title}
                </a>
              </div>
            )}
            {evt.payload.comment && (
