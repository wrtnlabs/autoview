...
export type AutoViewInput =
  AutoViewInputSubTypes.IApiInstallationRepositories.GetResponse;
...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  // Empty state when no repositories are available
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md">
      <div className="flex items-center mb-4">
        <LucideReact.Github size={20} className="text-gray-600 mr-2" />
      ...
      <ul className="space-y-4">
        {repoList.map((repo) => {
          // Fallback avatar in case of load error
