...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const writerName = (() => {
    ...
    // customer
    return writer.member?.nickname ?? `Customer ${writer.id.slice(0, 8)}`;
  })();
  ...
  const snapshotDateFormatted = snapshotDate.toLocaleString(undefined, {
    year: "numeric",
    month: "short",
    day: "numeric",
    hour: "2-digit",
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-sm max-w-md mx-auto">
      ...
      <div className="flex items-center text-sm text-gray-500 mt-2">
        ...
        <span className="ml-1">{snapshotDateFormatted}</span>
      </div>
