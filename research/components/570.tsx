...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  // Truncate description to a reasonable length for mobile-first view
  ...
  return (
    <div className="max-w-xl bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-colors flex flex-col md:flex-row gap-4">
      {/* Owner Avatar */}
      ...
      <div className="flex-1 flex flex-col">
        {/* Header: Repository Name & Privacy */}
        ...
        <div className="flex flex-wrap items-center gap-4 mt-4 text-gray-600 text-sm">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-1">{open_issues_count} issues</span>
          </div>
          <div className="flex items-center">
            <LucideReact.Eye size={16} />
            <span className="ml-1">{watchers_count}</span>
          </div>
          <div className="flex items-center">
