...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  return (
    <div className="p-4 bg-gray-50 rounded-lg">
      {/* Pagination Info */}
      <div className="mb-4 flex items-center text-sm text-gray-600 space-x-2">
        <LucideReact.List size={16} className="text-gray-600" aria-label="List" />
        <span>
          Page {current} of {pages}
        </span>
        <span className="mx-1">|</span>
        <span>Total coupons: {records}</span>
      </div>
        ...
        {coupons.map((coupon) => {
          ...
          return (
            ...
            >
              ...
              {/* Details Grid */}
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-sm text-gray-600">
                ...
                <div className="flex items-center space-x-1">
                  <LucideReact.User
                    ...
                    aria-label="Designer"
                  />
                  <span>Designer: {coupon.designer.id}</span>
                </div>
                <div className="flex items-center space-x-1">
                  ...
                  />
                  <span>Opened: {formatDate(coupon.opened_at)}</span>
                </div>
                <div className="flex items-center space-x-1">
                  <LucideReact.Calendar
                    size={16}
                  ...
                  />
                  <span>Closed: {formatDate(coupon.closed_at)}</span>
                </div>
                <div className="flex items-center space-x-1">
                  <LucideReact.ListChecks
                    ...
                    aria-label="Criteria"
                  />
                  <span>Criteria: {coupon.criterias.length}</span>
                </div>
                <div className="flex items-center space-x-1 sm:col-span-2 lg:col-span-1">
                  <LucideReact.Users
                    size={16}
                    className="text-gray-500"
                    aria-label="Per Citizen"
                  />
                  <span>Per Citizen: {invPerCitizen}</span>
                </div>
              </div>
            </div>
          );
