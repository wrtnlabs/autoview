...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const placeholderImg =
    "https://placehold.co/400x225/e2e8f0/1e293b?text=Image";
  ...
  return (
    <div className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {data.map((item) => {
          const { content, price_range, latest, categories, tags, units } =
            item;
          const imgSrc = content.thumbnails[0]?.url || placeholderImg;
          ...
          return (
            ...
            >
              ...
              {/* Latest Badge */}
              {latest && (
                <div className="inline-flex items-center text-green-600 text-sm font-medium mb-2">
              ...
              <div className="flex items-center text-gray-700 text-sm mb-2">
                ...
                <span>
                  Price: {formatNumber(price_range.lowest.real)} -{" "}
                  {formatNumber(price_range.highest.real)}
                </span>
              </div>
