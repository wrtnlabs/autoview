...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const editedCount = snapshots.length > 1 ? snapshots.length - 1 : 0;
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md max-w-full">
      <div className="flex items-center justify-between mb-2">
        ...
        {editedCount > 0 && (
          <span className="text-xs text-gray-400">Edited {editedCount} times</span>
        )}
      </div>
      <div className="text-gray-800 text-base break-words line-clamp-3">
        {body}
      </div>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {attachments.map((file) => {
            ...
            return (
              <div
                key={file.url}
                className="flex items-center bg-gray-100 text-blue-600 text-sm px-2 py-1 rounded"
              >
