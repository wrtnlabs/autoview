  ...
  if (!value || value.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-8 text-gray-500">
        ...
        <p className="mt-4 text-lg">No migrations available</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      {value.map((migration) => {
        ...
        // Prepare exclude badges
        const excludes = migration.exclude || [];
        return (
          <div
            key={migration.id}
            className="w-full bg-white rounded-lg shadow-md p-4 flex flex-col md:flex-row md:justify-between"
          >
            <div className="flex-1">
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center bg-indigo-100 text-indigo-800 text-xs font-medium px-2.5 py-0.5 rounded">
                  {migration.state}
                </span>
              </div>
            ...
            <div className="mt-3 sm:mt-0 flex flex-wrap items-center gap-2">
              {migration.lock_repositories && (
                <div className="flex items-center gap-1 bg-gray-100 text-gray-800 text-xs px-2 py-0.5 rounded">
              ...
              {excludes.map((item) => (
                <span
                  key={item}
                  className="inline-flex items-center bg-red-100 text-red-800 text-xs px-2 py-0.5 rounded"
                >
                  Exclude:{item}
                </span>
              ))}
