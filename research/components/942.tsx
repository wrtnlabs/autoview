...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  if (state === "Available") {
    ...
    ["Unavailable", "Failed", "Deleted", "ShuttingDown"].includes(state)
  ) {
    ...
    <div className="p-4 bg-white rounded-lg shadow-md max-w-md mx-auto">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center">
          <StateIcon size={20} className={`${stateColor} mr-1`} />
      ...
      <div className="grid grid-cols-1 gap-2 text-sm text-gray-700">
        <div className="flex items-center">
          ...
          <span title="Last Used">Last used: {formattedLastUsed}</span>
        </div>
        <div className="flex items-center">
          <LucideReact.AlarmClock size={16} className="text-gray-400 mr-1" />
        ...
        <div className="flex items-center">
          <LucideReact.Users size={16} className="text-gray-400 mr-1" />
          <span>Billable owner: {value.billable_owner.login}</span>
        </div>
        <div className="flex items-center">
          <LucideReact.GitBranch size={16} className="text-gray-400 mr-1" />
          <span>Repository: {value.repository.full_name}</span>
        </div>
        {value.machine && (
          <div className="flex items-center">
            <LucideReact.Cpu size={16} className="text-gray-400 mr-1" />
            <span>Machine: {value.machine.display_name}</span>
          </div>
        )}
        <div className="flex items-center">
          <LucideReact.MapPin size={16} className="text-gray-400 mr-1" />
