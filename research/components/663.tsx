...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const branchName = value.head_branch ?? "N/A";
  ...
  // Status icon and label determination
  ...
  if (!value.status) {
    ...
    switch (value.status) {
      ...
      case "requested":
        ...
        statusLabel = value.status.replace(/_/g, " ");
        break;
      case "in_progress":
        StatusIcon = (
          <LucideReact.Loader
  ...
  // 2. JSX Structure
  return (
    <div className="max-w-md p-4 bg-white rounded-lg shadow space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
        <div className="flex items-center space-x-1">
          ...
          <span>{runsCount} Check Runs</span>
        </div>
        <div className="flex items-center space-x-1">
          <LucideReact.GitPullRequest size={16} />
          <span>{prCount} Pull Requests</span>
        </div>
        <div className="flex items-center space-x-1">
        ...
        <div className="flex items-center space-x-1 truncate">
          <LucideReact.Package className="text-gray-500" size={16} />
          <span>{appName}</span>
        </div>
      </div>
    </div>
