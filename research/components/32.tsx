    ...
    <div className="p-4 bg-white rounded-lg shadow-md space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b pb-3">
        <div className="flex items-center text-gray-700">
          <LucideReact.List className="mr-2" size={20} />
      ...
      <ul className="space-y-4">
        {data.map((review) => {
          const customerName = getCustomerLabel(review.customer);
          return (
            <li
              key={review.id}
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 text-sm text-gray-600 mt-2">
                ...
                <div className="flex items-center">
                  ...
                  <span>{review.read_by_seller ? "Viewed" : "Not Viewed"}</span>
                </div>
                <div className="flex items-center">
                  {review.answer ? (
                  ...
                  <span>
                    {review.answer
                      ? `Answered: ${formatDate(review.answer.created_at)}`
                      : "No Answer"}
                  </span>
                </div>
              </div>
