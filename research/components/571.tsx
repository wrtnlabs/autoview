...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const ownerDisplayName = owner.name || owner.login;
  const avatarFallback = `https://ui-avatars.com/api/?name=${encodeURIComponent(ownerDisplayName)}&background=0D8ABC&color=fff`;
      ...
      <div className="px-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-gray-600 mb-4">
          <div className="flex items-center">
            ...
            <span className="text-sm">{value.stargazers_count}</span>
          </div>
          <div className="flex items-center">
            <LucideReact.GitBranch size={16} className="mr-1 text-gray-500" />
            <span className="text-sm">{value.forks_count}</span>
          </div>
          <div className="flex items-center">
            <LucideReact.Eye size={16} className="mr-1 text-gray-500" />
            <span className="text-sm">{value.watchers_count}</span>
          </div>
          <div className="flex items-center">
            <LucideReact.AlertCircle size={16} className="mr-1 text-red-500" />
            <span className="text-sm">{value.open_issues_count}</span>
          </div>
        </div>
        ...
        {value.license && (
          <div className="flex items-center text-gray-600 mb-4">
            ...
            <span className="text-sm">
              License: {value.license.spdx_id || value.license.name}
            </span>
          </div>
        )}
