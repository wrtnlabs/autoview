  ...
  return (
    <div className="max-w-full p-4 bg-gray-50">
      ...
      <div className="space-y-4">
        {data.map((ticket) => {
          const issuedAt = formatDateTime(ticket.created_at);
          const expiresAt = ticket.expired_at
            ? formatDateTime(ticket.expired_at)
            : "No Expiration";
          const couponName = ticket.coupon.name;
          const accessLevel =
            ticket.coupon.restriction.access.charAt(0).toUpperCase() +
            ticket.coupon.restriction.access.slice(1);
          const channelName = ticket.customer.channel.name;
            ...
            >
              ...
              <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-gray-700">
                <div>
                  ...
                  <span className="text-gray-800">{issuedAt}</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="text-gray-800">{accessLevel}</span>
                </div>
                <div>
