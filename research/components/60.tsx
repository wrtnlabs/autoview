  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md overflow-x-auto">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-gray-800">Coupon Tickets</h2>
        <div className="text-sm text-gray-600">
          Page {pagination.current} / {pagination.pages} • {pagination.records}{" "}
          records
        </div>
      </div>
            ...
            return (
              <tr key={ticket.id}>
                ...
                <td className="px-4 py-2 text-sm text-gray-800 flex items-center">
                  <DiscountIcon size={16} className="text-gray-500 mr-1" />
                  ...
                  {ticket.expired_at ? (
                    <>
                      <LucideReact.Calendar
                        ...
                        className="text-gray-500 mr-1"
                      />
                      <span>{formatDateTime(ticket.expired_at)}</span>
                    </>
                  ) : (
