    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {installations.map((inst) => {
          const isSuspended = Boolean(inst.suspended_at);
          const statusLabel = isSuspended ? "Suspended" : "Active";
          const statusClasses = isSuspended
          ...
          return (
            ...
            >
              ...
              <div className="text-sm text-gray-500 space-y-1 mb-3">
                <div>Created: {formatDate(inst.created_at)}</div>
                <div>Updated: {formatDate(inst.updated_at)}</div>
              </div>
              {inst.events && inst.events.length > 0 && (
                <div className="flex flex-wrap gap-1 mb-3">
                  {inst.events.map((evt, idx) => (
                    <span
                      key={idx}
                      className="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded truncate"
                    >
                      {evt}
                    </span>
                  ))}
              ...
              {inst.contact_email && (
                <div className="mt-auto pt-2 border-t border-gray-200 text-sm text-gray-700">
