...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const { current, pages, records, limit } = value.pagination;
  const start = (current - 1) * limit + 1;
  const end = Math.min(records, current * limit);
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md">
      <div className="mb-4 text-sm text-gray-600">
        Showing {start}–{end} of {records} reviews (Page {current} of {pages})
      </div>
          ...
          return (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                ...
                <div className="mt-2 sm:mt-0 flex items-center text-sm text-gray-500 space-x-4">
                  <div className="flex items-center">
                    <LucideReact.Star className="text-amber-400" size={16} />
                    <span className="ml-1">{review.score.toFixed(1)}</span>
                  </div>
                  <div className="flex items-center">
              ...
              <div className="mt-3 flex flex-wrap items-center space-x-4 text-sm text-gray-500">
                ...
                <div className="flex items-center">
                  <LucideReact.Paperclip className="text-gray-400" size={16} />
                  <span className="ml-1">
                ...
                <div className="flex items-center">
                  {review.answer ? (
                    <>
                      ...
                      />
                      <span className="ml-1">
                        Answered on {formatDate(review.answer.created_at)}
                      </span>
                    </>
                  ) : (
                    <>
                      ...
                      />
                      <span className="ml-1">No answer</span>
                    </>
                  )}
                </div>
              </div>
