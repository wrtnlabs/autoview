...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
    ...
    <div className="p-4 bg-white rounded-lg shadow-md space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
        <div className="text-sm text-gray-600">
          Page {value.pagination.current} of {value.pagination.pages} &bull;{" "}
          {value.pagination.records} reviews
        </div>
      </div>
      ...
      <div className="divide-y divide-gray-200">
        {value.data.map((review) => (
          ...
          >
            ...
            {/* Answer Status */}
            <div className="mt-4 sm:mt-0 sm:ml-6 text-sm flex items-center">
              {review.answer ? (
                <>
                  <LucideReact.CheckCircle
                  ...
                  />
                  <span className="ml-1">
                    Answered on {formatDate(review.answer.updated_at)}
                  </span>
                </>
              ) : (
                <>
  ...
  //    All displayed data is filtered, transformed, and formatted as per guidelines.
}
