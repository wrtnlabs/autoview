    ...
    <div className="w-full p-4 bg-white rounded-lg shadow-md">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
        <div className="flex items-center text-sm text-gray-600 space-x-2">
          <LucideReact.ChevronsLeft size={16} className="opacity-50" />
          <span>
            Page {current} of {pages}
          </span>
          <LucideReact.ChevronsRight size={16} className="opacity-50" />
        </div>
        <div className="mt-2 sm:mt-0 flex items-center text-sm text-gray-600 space-x-1">
          <LucideReact.List size={16} />
          <span>
            {records} comment{records !== 1 ? "s" : ""}
          </span>
        </div>
      </div>
            ...
            <li key={comment.id} className="py-4">
              ...
              {latest.files.length > 0 && (
                <div className="mt-2 flex items-center space-x-2 text-sm text-gray-600">
                  ...
                  <span>
                    {latest.files.length} attachment
                    {latest.files.length > 1 ? "s" : ""}
                  </span>
                </div>
              )}
            </li>
