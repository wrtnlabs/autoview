...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  function getEventName(type: string | null): string {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm divide-y divide-gray-200">
      {sortedEvents.length === 0 ? (
        <div className="p-4 text-gray-400 flex items-center justify-center space-x-2">
        ...
        <ul>
          {sortedEvents.map((event) => {
            ...
            return (
              <li
                key={event.id}
                className="p-4 flex space-x-4 hover:bg-gray-50"
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-1 flex items-center text-gray-600 space-x-1 text-sm">
