...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  return (
    <div className="max-w-full p-4 bg-gray-50 space-y-6">
      {/* Pagination Header */}
      <div className="flex justify-between items-center bg-white p-4 rounded-lg shadow">
        ...
        <div className="text-sm text-gray-500">{records} Reviews</div>
      </div>
      ...
      <div className="space-y-4">
        {data.map((review) => (
          <div
            key={review.id}
            className="bg-white p-5 rounded-lg shadow flex flex-col space-y-3"
          >
            {/* Title */}
            ...
            <div className="flex flex-wrap items-center text-sm text-gray-600 gap-4">
              ...
              {/* Read Status */}
              <div className="flex items-center">
                <span className="mr-1">Seller Viewed:</span>
            ...
            {/* Body Preview */}
            <p className="text-gray-700 text-sm line-clamp-3">{review.body}</p>
            ...
            {review.files.length > 0 && (
              <div className="flex flex-wrap items-center gap-3 overflow-x-auto pt-2">
