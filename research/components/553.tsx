  ...
  if (repos.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-6 text-gray-500">
        <LucideReact.AlertCircle size={48} aria-label="No repositories" />
          ...
          >
            ...
            {topics.length > 0 && (
              <div className="flex flex-wrap items-center gap-2 mb-3">
                {topics.slice(0, 5).map((topic) => (
                  <span
                    key={topic}
                    className="flex items-center bg-gray-100 text-gray-700 text-xs font-medium px-2 py-1 rounded"
                  >
            ...
            {repo.license && (
              <div className="mt-2 text-xs text-gray-400 flex items-center">
                ...
                <span>{repo.license.name || repo.license.key}</span>
              </div>
            )}
          </div>
        );
