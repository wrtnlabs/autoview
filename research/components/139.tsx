  ...
  const writerName = (() => {
    if ("type" in writer) {
      switch (writer.type) {
        ...
        case "customer":
          return writer.member?.nickname ?? "Guest Customer";
      }
    }
    return "User";
  })();

  const postedDate = new Date(value.created_at).toLocaleString(undefined, {
    month: "short",
    day: "numeric",
    year: "numeric",
    hour: "2-digit",
  ...
  return (
    <div className="max-w-md mx-auto p-4 bg-white rounded-lg shadow-md">
      ...
      <div className="flex items-center mb-3">
        <LucideReact.User size={20} className="text-gray-500 flex-shrink-0" />
        <span className="ml-2 font-semibold text-gray-800">{writerName}</span>
      ...
      <div className="text-gray-700 mb-2">
        {latestSnapshot.format === "html" ? (
          ...
          <p className="whitespace-pre-wrap">{latestSnapshot.body}</p>
        )}
      </div>
