...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const getWriterName = (
    ...
    if ("type" in writer) {
      ...
      if (writer.type === "customer") {
        return writer.member?.nickname ?? "Guest";
      }
    }
    return "User";
  };
  ...
  const getWriterIcon = (
    ...
    if ("type" in writer) {
      switch (writer.type) {
        case "administrator":
          return <LucideReact.UserCheck className="text-blue-500" size={16} />;
        case "seller":
          return <LucideReact.Store className="text-green-500" size={16} />;
        case "customer":
          return <LucideReact.User className="text-gray-500" size={16} />;
      }
    }
    return <LucideReact.User className="text-gray-500" size={16} />;
  };
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2 text-sm font-medium text-gray-800">
                  ...
                  <span>{getWriterName(comment.writer)}</span>
                </div>
