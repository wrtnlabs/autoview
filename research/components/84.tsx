...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const discount = value.nominal - value.real;
    ...
    <div className="p-4 bg-white rounded-lg shadow-md space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-center justify-between">
          <span className="text-gray-600">Nominal Price</span>
          <span className="text-gray-800 font-medium">
            {formatNumber(value.nominal)}
          </span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-gray-600">Payable Price</span>
          <span className="text-gray-800 font-medium">
            {formatNumber(value.real)}
          </span>
        </div>
        {discount > 0 && (
          <div className="col-span-2 flex items-center justify-between text-green-600">
            <LucideReact.ArrowDownCircle className="mr-1" size={16} />
            <span className="flex-1 text-gray-600">Discount Applied</span>
      ...
      {/* Payment Breakdown */}
      <div>
        <h3 className="text-gray-700 font-semibold mb-2">Payment Breakdown</h3>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="flex items-center space-x-2">
            <LucideReact.DollarSign className="text-green-500" size={16} />
            <span className="text-gray-800">Cash:</span>
            <span className="ml-auto font-medium">
              {formatNumber(value.cash)}
            </span>
          </div>
          <div className="flex items-center space-x-2">
            <LucideReact.Wallet className="text-blue-500" size={16} />
          ...
          <div className="flex items-center space-x-2">
            <LucideReact.MapPin className="text-yellow-500" size={16} />
          ...
          <div className="flex items-center space-x-2">
            <LucideReact.Ticket className="text-purple-500" size={16} />
            <span className="text-gray-800">Ticket:</span>
            <span className="ml-auto font-medium">
      ...
      {/* Coupon Details */}
      {value.ticket_payments.length > 0 && (
        <div>
          <h3 className="text-gray-700 font-semibold mb-2">Coupons Used</h3>
          <ul className="space-y-2">
            {value.ticket_payments.map((tp) => (
              <li key={tp.id} className="flex items-center space-x-2">
                <LucideReact.Tag className="text-blue-500" size={16} />
                <span className="text-gray-800 truncate">
                  {tp.ticket.coupon.name}
                </span>
