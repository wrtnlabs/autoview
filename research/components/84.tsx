...
export default function VisualComponent(value: AutoViewInput): React.ReactNode {
  ...
  const couponNames =
    value.ticket_payments?.map((p) => p.ticket.coupon.name).filter(Boolean) ||
    [];
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md max-w-md mx-auto">
      <h2 className="flex items-center text-lg font-semibold text-gray-800 mb-4">
        <LucideReact.ShoppingCart className="mr-2 text-blue-500" size={20} />
        Order Price Summary
      </h2>
      ...
      <div className="mt-4 border-t pt-4 space-y-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center text-gray-700">
            <LucideReact.DollarSign size={16} className="mr-1" />
            Cash
          </div>
          <span className="font-medium">{formatAmount(value.cash)}</span>
        </div>

        <div className="flex items-center justify-between">
          <div className="flex items-center text-gray-700">
            <LucideReact.Wallet size={16} className="mr-1" />
            Deposit
          </div>
          <span className="font-medium">{formatAmount(value.deposit)}</span>
        </div>

        <div className="flex items-center justify-between">
          <div className="flex items-center text-gray-700">
            <LucideReact.Award size={16} className="mr-1" />
            Mileage
          </div>
          <span className="font-medium">{formatAmount(value.mileage)}</span>
        </div>

        {value.ticket_payments?.length > 0 && (
          <div className="flex items-start justify-between">
            <div className="flex items-center text-gray-700">
              <LucideReact.Ticket size={16} className="mr-1" />
              Coupons Used
            </div>
            <div className="text-right">
              <span className="font-medium">{formatAmount(value.ticket)}</span>
