...
type IAutoViewTransformerInputType = Schema.IApiOrgsDependabotSecretsRepositories.GetResponse;
...
function visualizeData(
  ...
  const items: IAutoView.IAutoViewDataListItemProps[] = input.repositories.map(
    (repo) => {
