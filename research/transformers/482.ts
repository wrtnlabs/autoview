...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  const items: IAutoView.IAutoViewListItemProps[] = input.map(mig => {
    ...
    const endElements: IAutoView.IAutoViewListItemProps["endElement"] = [
      stateChip,
      repoBadge,
      ...(lockIcon ? [lockIcon] : []),
      createdText,
    ...
    return {
      ...
      description: `Owner: ${mig.owner?.login ?? "Unknown"}`,
      startElement: avatar,
