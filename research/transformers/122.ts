    ...
    export namespace IPageIShoppingDelivery {
        ...
        */
        export type IInvert = {
            ...
            */
            data: Schema.IShoppingDelivery.IInvert[];
        };
    }
...
type IAutoViewTransformerInputType = Schema.IPageIShoppingDelivery.IInvert;
...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  const items: IAutoView.IAutoViewDataListItemProps[] = deliveries.map(delivery => {
    // Create small summary chips: state, orders count, shippers count, journeys count
    const summaryChips: IAutoView.IAutoViewChipProps[] = [
      {
        type: "Chip",
