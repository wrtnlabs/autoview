...
type IAutoViewTransformerInputType = Schema.IApiOrgsActionsPermissionsRepositories.GetResponse;
...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  const listItems: IAutoView.IAutoViewListItemProps[] = repositories.map(repo => {
    ...
    const starChip: IAutoView.IAutoViewChipProps = {
      type: "Chip",
