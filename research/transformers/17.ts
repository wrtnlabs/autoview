...
namespace Schema {
    ...
    */
    export type IPageIShoppingMileageDonation = {
        ...
        */
        data: Schema.IShoppingMileageDonation[];
    };
...
type IAutoViewTransformerInputType = Schema.IPageIShoppingMileageDonation;
...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  data.forEach((donation) => {
    ...
    const amountBadge: IAutoView.IAutoViewBadgeProps = {
      type: "Badge",
