...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
    ...
    const header: IAutoView.IAutoViewCardHeaderProps = {
        ...
        description: input.private
            ? `🔒 Private repository • ${input.language ?? "Unknown language"}`
            : `🌐 Public repository • ${input.language ?? "Unknown language"}`,
        startElement: {
            type: "Avatar",
    ...
    const descriptionMd: IAutoView.IAutoViewMarkdownProps = {
        type: "Markdown",
