...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
    ...
    const header: IAutoView.IAutoViewCardHeaderProps = {
        ...
        // mark if this snapshot is the latest
        ...(input.latest && {
            endElement: {
                type: "Chip",
                label: "Latest",
    ...
    const media: IAutoView.IAutoViewCardMediaProps | null =
    ...
    const tagChips: IAutoView.IAutoViewChipGroupProps = {
        type: "ChipGroup",
    ...
    const unitListItems: IAutoView.IAutoViewDataListItemProps[] = input.units.map((unit) => {
        // for each stock, build a Chip
        const stockChips: IAutoView.IAutoViewChipGroupProps = {
            type: "ChipGroup",
        ...
        return {
            ...
            value: stockChips as IAutoView.IAutoViewChipGroupProps,
        };
    });
    ...
    const children = [header, media, content, footer].filter(
        (comp): comp is Exclude<typeof comp, null> => comp !== null
    );
