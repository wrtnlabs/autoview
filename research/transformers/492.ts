...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  const packageTypeColorMap: Record<Schema._package["package_type"], IAutoView.IAutoViewChipProps["color"]> = {
    npm: "orange",
    maven: "blue",
    rubygems: "red",
    docker: "cyan",
  ...
  const visibilityColorMap: Record<Schema._package["visibility"], IAutoView.IAutoViewChipProps["color"]> = {
    public: "success",
    private: "error",
  };
