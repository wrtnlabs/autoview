...
type IAutoViewTransformerInputType = Schema.authentication_token;
...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
  ...
  const repoItems: IAutoView.IAutoViewDataListItemProps[] = (repositories ?? []).map((repo) => {
  ...
  const repoCountBadge: IAutoView.IAutoViewBadgeProps = {
    type: "Badge",
  ...
  const selectionChip: IAutoView.IAutoViewChipProps = {
    type: "Chip",
    label:
