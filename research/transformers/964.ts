...
function visualizeData(input: IAutoViewTransformerInputType): IAutoView.IAutoViewComponentProps {
    ...
    const listItems: IAutoView.IAutoViewListItemProps[] = input.map((migration) => {
        ...
        const ownerElement: IAutoView.IAutoViewAvatarProps | IAutoView.IAutoViewIconProps = migration.owner
            ? {
                  type: "Avatar",
