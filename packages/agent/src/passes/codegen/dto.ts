...
export interface Input {
  ...
  /**
   * The detailed instruction to generate the component.
   *
   * If provided, the component will be generated by following the context.
   *
   * This is useful to fix existing component issues or modify the component with special design considerations.
   */
  context?: string;
