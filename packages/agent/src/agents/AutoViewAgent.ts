...
export class AutoViewAgent {
   ...
   * @param transformFunctionName - The name of the transform function generated by the agent. Give different names if you plan to generate multiple transform functions to prevent name conflicts.
